                    ...
                    <tbody>
                        ...
                        @foreach ($books as $item)
                            <tr>
                                ...
                                <td>{{ $item->judul }}</td>
                                <td>
                                    <img src="{{ Storage::url('public/books/') . $item->picture }}"
                                        class="rounded" style="width: 165px">
                                </td>
                                ...
                                <td>
                                    ...
                                    <form action="{{ url('buku/' . $item->id_buku) }}" class="d-inline"
                                        method="POST"
