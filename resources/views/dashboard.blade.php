                                ...
                                <table class="table table-hover table-lg">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <th scope="row">
                                                <a>
                                                    <img style="width: 50%" src="{{ Storage::url('public/blog/') . $popularBlog->picture }}"
                                                        alt="">
                                                </a>
                                            </th>
                                            <td>
                                                <a href="{{ url('blog/' . $popularBlog->id_blog) }}"
                                                    class="text-primary fw-bold">
                                                    {{ $popularBlog->title }}
                                                </a>
                                            </td>
                                            <td>{{ $popularBlog->author_name }}</td>
                                            <td>{{ $popularBlog->views }}</td> --}}
                                        {{-- </tr>
                                    @endforeach --}}
...
<script src="{{ asset('assetsad/static/js/pages/dashboard.js') }}"></script>
@endsection
